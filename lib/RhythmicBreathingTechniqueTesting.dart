...
import 'package:rhythmicbreathingtechnique/responsive/ResponsiveRhytmicScreen.dart';
...
class RhythmicBreathingTechniqueTesting extends StatefulWidget {
  const RhythmicBreathingTechniqueTesting({Key? key}) : super(key: key);
...
class _RhythmicBreathingTechniqueState
    extends State<RhythmicBreathingTechniqueTesting>
    with TickerProviderStateMixin {
  late RhythmicBreathingProvider _provider;
  late ConfettiController _controllerCenter;
  final List<double> sizes = [10,15,15,10,10];//  final List<double> sizes = [150, 250, 250, 150, 150];
  final List<double> centerCircleSizes = [40, 90, 90, 40, 40];
  final List<int> duration = [0, 2, 1, 2, 1];  //final List<int> duration = [0, 4, 2, 4, 2];
  ...
  //               Center(
  //                   child:
  //                       //  Container(decoration: BoxDecoration(shape:BoxShape.circle,border: Border.all(color:Colors.white,width: 1)),
  //                       Positioned(
  //                           top: 350,
  //                           left: 50,
  //                           right: 50,
  ...
  Widget circleAnimation() {
    ...
    //             ),
    //             offset: Offset(
    //                 MediaQuery.of(context).size.width*0.4*math.cos(0.0 + 3 * math.pi / 2),
    //             //dotRadius  9.5  math.cos(0.0 + 3 * math.pi / 2),
    //               MediaQuery.of(context).size.height*0.4*math.sin(0.0 +3 * math.pi / 2),
    //       )),
    //
    // ),
          RotationTransition(
  ...
  Widget build(BuildContext context) {
    sizes.clear();
    sizes.add(MediaQuery.of(context).size.width*0.15);
    sizes.add(MediaQuery.of(context).size.width*0.25);
    sizes.add(MediaQuery.of(context).size.width*0.25);
    sizes.add(MediaQuery.of(context).size.width*0.15);
    sizes.add(MediaQuery.of(context).size.width*0.15);
